...
class ReleaseNoteServiceTest {
    ...
    @Test
    void getAllEntries_WithValidReleaseId_ShouldReturnEntries() throws JacksonException {
        // Given
    ...
    @Test
    void getAllEntries_WithValidSlug_ShouldReturnEntries() throws JacksonException {
        // Given
    ...
    @Test
    void createEntry_WithMicroserviceId_ShouldCreateEntry() throws JacksonException {
        // Given
        when(releaseRepository.findBySlug("release123")).thenReturn(Optional.empty());
        when(releaseRepository.findById("release123")).thenReturn(Optional.of(testRelease));
        when(microserviceRepository.findById("ms123")).thenReturn(Optional.of(testMicroservice));
    ...
    @Test
    void createEntry_WithLegacyMicroserviceName_ShouldCreateEntry() throws JacksonException {
        // Given
    ...
    @Test
    void createEntry_WithJsonError_ShouldSetEmptyChanges() throws JacksonException {
        // Given
        when(releaseRepository.findBySlug("release123")).thenReturn(Optional.empty());
        when(releaseRepository.findById("release123")).thenReturn(Optional.of(testRelease));
        when(microserviceRepository.findById("ms123")).thenReturn(Optional.of(testMicroservice));
        when(objectMapper.writeValueAsString(anyList())).thenThrow(new JacksonException("Error") {
        });
        when(releaseNoteEntryRepository.save(any(ReleaseNoteEntry.class))).thenReturn(testEntry);
    ...
    @Test
    void updateEntry_WithValidData_ShouldUpdateEntry() throws JacksonException {
        // Given
        when(releaseRepository.findBySlug("release123")).thenReturn(Optional.empty());
        when(releaseRepository.findById("release123")).thenReturn(Optional.of(testRelease));
    ...
    @Test
    void exportMarkdown_ShouldGenerateMarkdown() throws JacksonException {
        // Given
        testEntry.setPartEnMep(true);
        when(releaseRepository.findBySlug("release123")).thenReturn(Optional.empty());
        when(releaseRepository.findById("release123")).thenReturn(Optional.of(testRelease));
    ...
    @Test
    void exportMarkdown_ShouldOnlyIncludeDeployedEntries() throws JacksonException {
        // Given
    ...
    @Test
    void exportHtml_ShouldGenerateHtml() throws JacksonException {
        // Given
        testEntry.setPartEnMep(true);
        when(releaseRepository.findBySlug("release123")).thenReturn(Optional.empty());
        when(releaseRepository.findById("release123")).thenReturn(Optional.of(testRelease));
    ...
    @Test
    void exportHtml_ShouldOnlyIncludeDeployedEntries() throws JacksonException {
        // Given
        ReleaseNoteEntry notDeployed = new ReleaseNoteEntry();
        notDeployed.setId("entry2");
        notDeployed.setReleaseId("release123");
