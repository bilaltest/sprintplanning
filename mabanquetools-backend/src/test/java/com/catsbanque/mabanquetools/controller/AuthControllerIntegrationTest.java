...
class AuthControllerIntegrationTest {
        ...
        void testRegister_Success() throws Exception {
                ...
                mockMvc.perform(post("/auth/register")
                                ...
                                .andExpect(jsonPath("$.user.password").doesNotExist()); // Password ne doit pas être
                                                                                        // exposé
        }
        ...
        @Test
        @DisplayName("POST /api/auth/register - Mot de passe simple accepté")
        void testRegister_SimplePassword() throws Exception {
                // Given
        ...
        void testLogin_EmailNotFound() throws Exception {
                ...
                mockMvc.perform(post("/auth/login")
                                ...
                                .andExpect(jsonPath("$.error.message")
                                                .value(containsString("Email ou mot de passe incorrect")));
        }
