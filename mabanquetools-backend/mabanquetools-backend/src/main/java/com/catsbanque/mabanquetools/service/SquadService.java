...
public class SquadService {
    ...
    public static class UpdateSquadRequest {
        ...
        public String getTontonMep() {
            return tontonMep;
        }

        public void setTontonMep(String tontonMep) {
            this.tontonMep = tontonMep;
        }
        ...
        public Boolean getFeaturesEmptyConfirmed() {
            return featuresEmptyConfirmed;
        }

        public void setFeaturesEmptyConfirmed(Boolean featuresEmptyConfirmed) {
            this.featuresEmptyConfirmed = featuresEmptyConfirmed;
        }

        public Boolean getPreMepEmptyConfirmed() {
            return preMepEmptyConfirmed;
        }

        public void setPreMepEmptyConfirmed(Boolean preMepEmptyConfirmed) {
            this.preMepEmptyConfirmed = preMepEmptyConfirmed;
        }

        public Boolean getPostMepEmptyConfirmed() {
            return postMepEmptyConfirmed;
        }

        public void setPostMepEmptyConfirmed(Boolean postMepEmptyConfirmed) {
            this.postMepEmptyConfirmed = postMepEmptyConfirmed;
        }
    }
}
