    ...
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-500 via-primary-600 to-primary-700 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 px-4">
      <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
          <div class="inline-flex items-center justify-center w-20 h-20 bg-gray-50 dark:bg-gray-900 rounded-full shadow-xl mb-4">
            <span class="material-icons text-5xl text-primary-600 dark:text-primary-400">calendar_month</span>
          </div>
          <h1 class="text-3xl font-bold text-white mb-2">Planning DSI</h1>
          <p class="text-primary-100 dark:text-gray-400">Gestion d'événements</p>
        </div>

        <!-- Login Form -->
        <div class="bg-gray-50 dark:bg-gray-900 rounded-2xl shadow-2xl p-8">
          ...
          <form (ngSubmit)="onSubmit()" class="space-y-6">
            ...
            <div>
              ...
              <!-- Error Message -->
              <p *ngIf="showError" class="mt-2 text-sm text-red-600 dark:text-red-400 flex items-center space-x-1">
          ...
          <div class="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
            <div class="flex items-start space-x-2">
              ...
              <p class="text-xs text-blue-800 dark:text-blue-300">
                Accès sécurisé à l'application de planning.
                Une authentification par API externe sera mise en place prochainement.
              </p>
            </div>
          </div>
        </div>
...
export class LoginComponent {
  ...
  async onSubmit(): Promise<void> {
    ...
    // Simuler un délai de requête réseau
